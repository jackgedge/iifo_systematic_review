\begin{table*}[!t]
\caption{Grouped Univariate Association Testing test results.}
...
\hspace{1em}41--60 & 2.49 [0.42, 14.83] (p=0.289) & 2.70 [0.71, 10.22] (p=0.188) & 0.18 [0.04, 0.76] (p=0.019)* & --- & 0.54 [0.15, 2.00] (p=0.488) \\
...
\hspace{1em}Intent to harm & --- & 0.49 [0.16, 1.55] (p=0.347) & 5.40 [1.36, 21.43] (p=0.024)* & --- & 0.84 [0.28, 2.56] (p=0.988) \\
...
\hspace{1em}Other & 1.19 [0.13, 11.18] (p=1.000) & 3.04 [0.70, 13.29] (p=0.161) & 0.14 [0.03, 0.75] (p=0.023)* & 7.75 [0.44, 136.41] (p=0.236) & 0.58 [0.14, 2.40] (p=0.469) \\
...
\hspace{1em}Sharp & 1.56 [0.32, 7.51] (p=0.700) & 0.34 [0.13, 0.90] (p=0.048)* & 2.16 [0.82, 5.72] (p=0.187) & 1.12 [0.07, 18.65] (p=1.000) & 1.09 [0.41, 2.90] (p=1.000) \\
