...
\small
\begin{tabular}{p{3.5cm} p{4.1cm} p{4.1cm} p{4.1cm} p{4.1cm} p{4.1cm} }
\toprule
...
\hspace{1em}Child/Adolescent (\textless 18) & 1.93 [0.33, 11.24] (p=0.604) & 0.32 [0.08, 1.29] (p=0.178) & 2.53 [0.63, 10.15] (p=0.307) & --- & 1.89 [0.47, 7.65] (p=0.521) \\
...
\hspace{1em}Long (\textgreater 5cm) & 0.44 [0.08, 2.44] (p=0.442) & 0.76 [0.29, 1.97] (p=0.746) & 2.56 [0.94, 6.94] (p=0.106) & 1.19 [0.07, 19.88] (p=1.000) & 1.96 [0.70, 5.49] (p=0.304) \\
...
\hspace{1em}Large Diameter (\textgreater 2.5cm) & 0.22 [0.04, 1.10] (p=0.070) & 1.29 [0.43, 3.86] (p=0.857) & 1.83 [0.62, 5.44] (p=0.413) & --- & 1.00 [0.32, 3.13] (p=1.000) \\
