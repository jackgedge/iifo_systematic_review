...
Furthermore, extreme cases of recurrent intentional ingestion cause 'countertransference anger' \cite{Palese_2012} among clinicians who have to endure sometimes years of repeat encounters with prolific recurrent ingestors, who are often complex patients with complex mental health needs. This is well described by Gitlin \textit{et al.} \cite{Gitlin_2007} who describes how clinicians are \enquote{held hostage} by ingestors \enquote{in the midst of their self-harming process} after an initiating an \enquote{ongoing injurous sequence}. 
...
Time to presentation was not recorded. Ingestors that present early have increased endoscopy rates. This may have skewed endoscopy rates in some cases reports and case series, but the effect cannot be quantified in this review. 

Also, this review did not record any alteration of objects that ingestors may have undertaken. Although, in clinical practice, this is likely difficult to assess practically. Items may appear radiopaque and sharp imaging, but wrapped by the ingestor to reduce morbidity \cite{Ataya_2013,Albeldawi_2014}. Perhaps one day motivation could serve as a surrogate marker.
