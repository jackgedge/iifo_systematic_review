...
\centering
\includegraphics[width=\textwidth]{figures/prisma_checklist_0.jpg}
\caption{PRISMA Checklist (page 1)}
\label{fig:prisma_checklist_0}
\end{sidewaysfigure}

\begin{sidewaysfigure}
\centering
\includegraphics[width=\textwidth]{figures/prisma_checklist_1.jpg}
\caption{PRISMA Checklist (page 2)}
\label{fig:prisma_checklist_1}
\end{sidewaysfigure}

\begin{sidewaysfigure}
\centering
\includegraphics[width=\textwidth]{figures/prisma_checklist_2.jpg}
\caption{PRISMA Checklist (page 3)}
\label{fig:prisma_checklist_2}
\end{sidewaysfigure}
