...
Case series populations were exclusively male and detained, with pooled protest motivation $\approx$80\% and sharp object ingestion $\approx$90\%. Meta-regression showed protest motivation significantly reduced odds of surgery ($\beta = -0.021$, $p = 0.003$). Intent-to-harm trended towards increased surgery ($\beta = 0.257$, $p = 0.133$).
