...
\begin{center}
  \begin{sideways}
    \includegraphics[width=0.9\textheight]{figures/prisma_checklist_0.jpg}
  \end{sideways}
\end{center}

\begin{center}
  \begin{sideways}
    \includegraphics[width=0.9\textheight]{figures/prisma_checklist_1.jpg}
  \end{sideways}
\end{center}

\begin{center}
  \begin{sideways}
    \includegraphics[width=0.9\textheight]{figures/prisma_checklist_2.jpg}
  \end{sideways}
\end{center}
