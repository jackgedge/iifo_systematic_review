...
Data were initially extracted by a single reviewer (JGE) into \textit{Microsoft Excel} \cite{MicrosoftCorporation_2025} and processed in \textit{Python}~\cite{PythonSoftwareFoundation} using \textit{Pandas}~\cite{ThePandasDevelopmentTeam}. This process is outlined in Appendix~\ref{appendix:data_extraction}. 
