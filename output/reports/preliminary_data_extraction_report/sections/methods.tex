...
\subsection{Design}
A systematic review was chosen to...
...
The search was conducted using keywords and MeSH terms based on the concepts underpinning this review. The bibliography of each included article was search for any further relevant articles. The keywords and MeSH terms used can be found in Appendix A.
...
% Switch temporarily to single-column:
\end{multicols}
\begin{multicols}{1}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/prisma_diagram.pdf}
    \caption{PRISMA 2020 flow diagram outlining the identification, screening, and inclusion of studies.}
    \label{fig:prisma-diagram}
\end{figure}

\end{multicols}

% Immediately back to two-column:
\begin{multicols}{2}

All identified articles were collated using Python (Pandas). Duplicate articles were identified and removed based on non-unique combinations of author, title, and DOI.
...
\subsubsection{PRISMA Diagram}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/prisma_diagram.pdf}
